INSERT INTO `pizzas` (`price`, `description`, `name`, `photo_url`, `created_at`) VALUES ('6.00', 'Una pizza che incarna la semplicità e l\'eleganza dell\'Italia. La base di pomodoro fresco è coronata da una soffice mozzarella e impreziosita da foglie di basilico aromatico. Un\'esplosione di sapori tradizionali che ti faranno sentire come se fossi seduto in una piazza italiana al tramonto.', 'Margherita', 'https://www.scattidigusto.it/wp-content/uploads/2018/03/pizza-margherita-originale-Scatti-di-Gusto-1280x670.jpg', '2023-06-25 18:00');
INSERT INTO `pizzas` (`price`, `description`, `name`, `photo_url`, `created_at`) VALUES ('8.00', 'Questa pizza è un\'armoniosa sinfonia di gusti e consistenze. La base di pomodoro si sposa con la morbida mozzarella, mentre il prosciutto cotto, delicato e saporito, si unisce ai funghi terrosi e aromatici. Ogni morso è un viaggio nei boschi e nei prati d\'Italia.', 'Prosciutto e funghi', 'https://upload.wikimedia.org/wikipedia/commons/6/6f/2014_Pizza_con_funghi_e_prosciutto_cotto_e_mozzarella_di_bufala.jpg', '2023-06-26 12:30');
INSERT INTO `pizzas` (`price`, `description`, `name`, `photo_url`, `created_at`) VALUES ('8.50', 'Preparati a un\'avventura gustativa audace con questa pizza che ha il giusto tocco di piccantezza. La base di pomodoro accoglie la mozzarella cremosa, mentre il salame piccante affettato aggiunge un pizzico di fuoco che accenderà i tuoi sensi. Una combinazione esplosiva di sapori per gli amanti del piccante.', 'Salame piccante', 'https://www.davesamericanfood.com/wp-content/uploads/2020/04/pepperoni-pizza-2048x1356.jpg.webp', '2023-06-29 21:05');
INSERT INTO `pizzas` (`price`, `description`, `name`, `photo_url`, `created_at`) VALUES ('9.00', 'Questa pizza è una festa per i palati audaci e giocosi. La base di pomodoro si unisce alla mozzarella filante, mentre i wurstel tagliati a rondelle offrono un\'esplosione di gusto affumicato e succoso. Le patatine croccanti completano questa combinazione straordinaria, aggiungendo una deliziosa texture e un tocco di divertimento ad ogni morso.', 'Wurstel e patatine', 'https://www.scattidigusto.it/wp-content/uploads/2015/11/pizza-wurstel-patatine-pomodoro-1280x853.jpg', '2023-07-01 09:00');
