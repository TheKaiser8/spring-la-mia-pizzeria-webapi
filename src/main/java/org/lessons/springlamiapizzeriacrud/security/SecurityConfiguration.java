...
public class SecurityConfiguration {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers("/pizzas/{id}").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/pizzas/edit/{id}").hasAuthority("ADMIN")
                .requestMatchers("/pizzas/delete/{id}").hasAuthority("ADMIN")
